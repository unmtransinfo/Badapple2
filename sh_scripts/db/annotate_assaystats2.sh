...
# Date: 11/22/2024
# Description:
# Annotate compound and scaffold tables with activity stats for Badapple2.
# Yes, this is very similar to badapple1_compairson/sh_scripts/annotate_assaystats.sh
